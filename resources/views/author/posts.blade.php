                ...
                <table class="table table-striped">
                    ...
                    @foreach($posts as $post)
                        <tr>
                            ...
                            <td>
                                <a href="{{ route('authorPostEdit', $post->id) }}" class="btn btn-warning">Edit</a>
                                {{--<form style="display: inline-block" id="deletePost-{{$post->id}}" action="{{ route('deletePost', $post->id) }}" method="POST">@csrf</form>--}}
            ...
            <div class="modal-dialog" role="document">
                <div class="modal-content">
                    ...
                    <div class="modal-footer">
                        ...
                        <form style="display: inline-block" id="deletePost-{{$post->id}}" action="{{ route('deletePost', $post->id) }}" method="POST">@csrf
